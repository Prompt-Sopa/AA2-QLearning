...
game = Catcher(width=200, height=320, init_lives=3)
...
agent = QAgent(game, actions, epsilon=1.0, min_epsilon=0.05, epsilon_decay=0.999,
                ...
                load_q_table_path="catcher_q_table.pkl")
...
for episode in range(num_episodes):
    ...
    if (episode + 1) % 100 == 0:
        ...
        agent.save_q_table("catcher_q_table.pkl")


print("Entrenamiento completado.")
agent.save_q_table("catcher_q_table_final.pkl")
